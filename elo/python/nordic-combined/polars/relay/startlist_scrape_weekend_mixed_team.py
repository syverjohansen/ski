...
def process_mixed_team_races(races_df: pd.DataFrame) -> None:
    ...
    men_elo_path = "~/ski/elo/python/nordic-combined/polars/excel365/men_chrono.csv"
    women_elo_path = "~/ski/elo/python/nordic-combined/polars/excel365/ladies_chrono.csv"
