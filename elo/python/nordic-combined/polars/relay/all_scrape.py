...
def fetch_season_links(year, sex='M'):
    ...
    # Use &hva=k to get all competitions (not just World Cup)
    base_url = f"https://firstskisport.com/nordic-combined/calendar.php?y={year}&hva=k{gender_param}"
...
def save_dataframes(men_df, ladies_df, base_path="~/ski/elo/python/nordic-combined/polars/relay/excel365"):
