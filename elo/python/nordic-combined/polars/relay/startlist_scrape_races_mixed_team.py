...
def process_races_mixed_team(races_file: str = None) -> None:
    ...
    """
    print("Processing Nordic Combined mixed team races")
...
def process_mixed_team_races(races_df: pd.DataFrame) -> None:
    ...
    men_elo_path = "~/ski/elo/python/nordic-combined/polars/relay/excel365/men_chrono.csv"
    women_elo_path = "~/ski/elo/python/nordic-combined/polars/relay/excel365/ladies_chrono.csv"
