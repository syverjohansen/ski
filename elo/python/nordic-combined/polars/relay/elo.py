...
def sex(df, sex):
    ...
    if(sex=="M"):
        df = pl.read_csv("~/ski/elo/python/nordic-combined/polars/relay/excel365/men_scrape_update.csv")
    else:
        df = pl.read_csv("~/ski/elo/python/nordic-combined/polars/relay/excel365/ladies_scrape_update.csv")
