...
def process_races_team(races_file: str = None) -> None:
    ...
    """
    print("Processing Nordic Combined team races")
    ...
    if races_file and os.path.exists(races_file):
        ...
        try:
            ...
            # Filter to only team races (not team sprint) from today
...
def process_gender_team_races(races_df: pd.DataFrame, gender: str) -> None:
    ...
    team_output_path = f"~/ski/elo/python/nordic-combined/polars/relay/excel365/startlist_team_races_{gender}.csv"
