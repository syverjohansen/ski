...
def ladies():
    ...
    L_Individual = pl.read_ipc(f'{base_path}/L_Individual.feather')
    L_Individual = L_Individual.rename({"Pelo": "Individual_Pelo", "Elo": "Individual_Elo"})
    
    L_Individual_Compact = pl.read_ipc(f'{base_path}/L_Individual_Compact.feather')
    ...
    L_Mass_Start = pl.read_ipc(f'{base_path}/L_Mass_Start.feather')
...
def men():
    ...
    # Load and rename specific race type Elo files
    M_Individual = pl.read_ipc(f'{base_path}/M_Individual.feather')
    M_Individual = M_Individual.rename({"Pelo": "Individual_Pelo", "Elo": "Individual_Elo"})
    
    M_Individual_Compact = pl.read_ipc(f'{base_path}/M_Individual_Compact.feather')
    ...
    M_Mass_Start = pl.read_ipc(f'{base_path}/M_Mass_Start.feather')
...
ladiesdf.write_ipc("~/ski/elo/python/nordic-combined/polars/relay/excel365/ladies_chrono.feather")
mendf.write_ipc("~/ski/elo/python/nordic-combined/polars/relay/excel365/men_chrono.feather")

# Also save as CSV for easier viewing/sharing
ladiesdf.write_csv("~/ski/elo/python/nordic-combined/polars/relay/excel365/ladies_chrono.csv")
mendf.write_csv("~/ski/elo/python/nordic-combined/polars/relay/excel365/men_chrono.csv")
