...
def process_races() -> None:
    ...
    try:
        races_df = pd.read_csv('~/ski/elo/python/nordic-combined/polars/excel365/races.csv')
...
# Filter races by type: individual, team, team sprint, and mixed team
    ...
    r_script_path = os.path.expanduser('~/blog/daehl-e/content/post/nordic-combined/drafts/race-picks.R')
    ...
    try:
        ...
        for athlete in athletes:
            ...
            row_data = {
                ...
                'Jump': athlete.get('Jump', ''),
                'Points': athlete.get('Points', ''),
                'JumpRank': athlete.get('JumpRank', ''),
                'Time': athlete.get('Time', ''),
                'TimeDiff': athlete.get('TimeDiff', '')
            }
...
def process_gender_races(races_df: pd.DataFrame, gender: str, host_nation: str) -> None:
    ...
    if consolidated_df is not None:
        ...
        output_path = f"~/ski/elo/python/nordic-combined/polars/excel365/startlist_races_{gender}.csv"
