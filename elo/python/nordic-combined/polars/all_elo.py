...
output_dir = os.path.expanduser("~/ski/elo/python/nordic-combined/polars/excel365")
...
def elo(df, base_elo=1300, K=1, discount=.85):
    """
    Calculate ELO ratings for all Nordic Combined athletes in the dataset
    ...
    for season in range(len(seasons)):
        ...
        for race in range(len(races)):
            ...
            if race_type == "Team":
                ...
                K_adj = K / 4
            elif race_type == "Team Sprint":
                # Team Sprint events have weight divided by 2
                K_adj = K / 2
            else:
