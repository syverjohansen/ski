...
ladiesdf.write_ipc("~/ski/elo/python/nordic-combined/polars/excel365/ladies_chrono.feather")
mendf.write_ipc("~/ski/elo/python/nordic-combined/polars/excel365/men_chrono.feather")
