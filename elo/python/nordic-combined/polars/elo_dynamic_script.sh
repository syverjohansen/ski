...
echo "Starting men's ELO dynamic calculations (all competitions)..."
...
echo "Starting ladies' ELO dynamic calculations (all competitions)..."
...
echo "All Nordic Combined ELO dynamic calculations completed!"
