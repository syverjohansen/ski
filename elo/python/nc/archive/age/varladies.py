...
ladiesdf = pd.read_pickle("~/ski/elo/python/nc/age/excel365/ladiesdf.pkl")
   ...
   # print(id_dict)
    ...
    #for season in range(10):
        ...
        for idd in ski_ids_s:
            ...
            endf = pd.DataFrame([[endseasondate, "Summer", "Break", "end", "L", None, None, 0
...
varladieselo.to_pickle("~/ski/elo/python/nc/age/excel365/varladies_all_k.pkl")
varladieselo.to_excel("~/ski/elo/python/nc/age/excel365/varladies_all_k.xlsx")
