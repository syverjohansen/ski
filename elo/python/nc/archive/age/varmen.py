...
mendf = pd.read_pickle("~/ski/elo/python/nc/age/excel365/mendf.pkl")
...
def hill(mendf, hill):
   # print(pd.unique(mendf['distance']))
    if(hill=="Large"):
        mendf = mendf.loc[mendf['hill']=="Large"]
    elif(hill=="Small"):
        mendf = mendf.loc[mendf['hill']=="Small"]
   ...
   # print(id_dict)
    ...
    for season in range(len(seasons)):
        ...
        for idd in ski_ids_s:
            ...
            endf = pd.DataFrame([[endseasondate, "Summer", "Break", "end", "M", None, None, 0,
...
#varmendf = distance(varmendf, "Tech")
#varmendf = discipline(varmendf, "F")
#varmendf = ms(varmendf, "1")
#varmendf = season(varmendf, 0, 9999)
varmenelo = male_elo(varmendf)
varmenelo.to_pickle("~/ski/elo/python/nc/age/excel365/varmen_all_k.pkl")
varmenelo.to_excel("~/ski/elo/python/nc/age/excel365/varmen_all_k.xlsx")
