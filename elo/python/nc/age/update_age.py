...
men_pkl = pd.read_pickle("~/ski/elo/python/nc/age/excel365/mendf.pkl")
update_mendf = pd.read_pickle("~/ski/elo/python/nc/age/excel365/menupdate_setup.pkl")

men_pkl = men_pkl.append(update_mendf, ignore_index=True)



ladies_pkl = pd.read_pickle("~/ski/elo/python/nc/age/excel365/ladiesdf.pkl")

update_ladiesdf =  pd.read_pickle("~/ski/elo/python/nc/age/excel365/ladiesupdate_setup.pkl")
...
mendf.to_pickle("~/ski/elo/python/nc/age/excel365/menupdate_setup.pkl")
mendf.to_excel("~/ski/elo/python/nc/age/excel365/menupdate_setup.xlsx")


ladiesdf = ladies_ages(ladies_pkl)
print(ladiesdf)
ladiesdf.to_pickle("~/ski/elo/python/nc/age/excel365/ladiesupdate_setup.pkl")
ladiesdf.to_excel("~/ski/elo/python/nc/age/excel365/ladiesupdate_setup.xlsx")
