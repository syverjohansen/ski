...
def ladies():
	lady_all_k = pd.read_excel('~/ski/elo/python/nc/age/excel365/varladies_all_k.xlsx', sheet_name="Sheet1", header=0)
...
def men():
	man_all_k = pd.read_excel('~/ski/elo/python/nc/age/excel365/varmen_all_k.xlsx', sheet_name="Sheet1", header=0)
...
ladiesdf = ladies()
ladiesdf.to_pickle("/Users/syverjohansen/ski/elo/python/nc/age/excel365/ladies_chrono.pkl")
ladiesdf.to_excel("/Users/syverjohansen/ski/elo/python/nc/age/excel365/ladies_chrono.xlsx")

mendf = men()		
mendf.to_pickle("/Users/syverjohansen/ski/elo/python/nc/age/excel365/men_chrono.pkl")
mendf.to_excel("/Users/syverjohansen/ski/elo/python/nc/age/excel365/men_chrono.xlsx")
