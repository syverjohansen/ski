...
def setup():
	...
	#print(refdf)
	xlsx = pd.ExcelFile("~/ski/elo/python/alpine/excel365/update_scrape.xlsx")
	df = pd.read_excel(xlsx, sheet_name = "Ladies", header=None)
	df.columns = ['date', 'city', 'country', 'level', 'sex', 'distance',  'place', 'name', 'nation', 'id']
...
df = setup()
print(df)
df.to_pickle("~/ski/elo/python/alpine/age/excel365/ladiesupdate_setup.pkl")
df.to_pickle("~/ski/elo/python/alpine/age/excel365/ladiesupdate_setup.xlsx")
