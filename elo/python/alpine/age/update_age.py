...
men_pkl = pd.read_pickle("~/ski/elo/python/alpine/age/excel365/mendf.pkl")
#update_mendf = pd.read_pickle("~/ski/elo/python/alpine/age/excel365/menupdate_setup.pkl")

#men_pkl = men_pkl.append(update_mendf, ignore_index=True)



ladies_pkl = pd.read_pickle("~/ski/elo/python/alpine/age/excel365/ladiesdf.pkl")
...
ladiesdf.to_pickle("~/ski/elo/python/alpine/age/excel365/ladiesupdate_setup.pkl")
ladiesdf.to_excel("~/ski/elo/python/alpine/age/excel365/ladiesupdate_setup.xlsx")
