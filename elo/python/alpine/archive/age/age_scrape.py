...
men_pkl = "~/ski/elo/python/alpine/excel365/mendf.pkl"
ladies_pkl = "~/ski/elo/python/alpine/excel365/ladiesdf.pkl"
...
def men_ages():
	...
	id_urls = list(map(lambda x: "https://firstskisport.com/alpine/athlete.php?id="+str(x), id_list))
...
def ladies_ages():
	...
	id_urls = list(map(lambda x: "https://firstskisport.com/alpine/athlete.php?id="+str(x)+"&g=F", id_list))
	print(len(id_urls))
...
mendf = men_ages()
print(mendf)
mendf.to_pickle("~/ski/elo/python/alpine/age/excel365/mendf.pkl")
mendf.to_excel("~/ski/elo/python/alpine/age/excel365/mendf.xlsx")


ladiesdf = ladies_ages()
print(ladiesdf)
ladiesdf.to_pickle("~/ski/elo/python/alpine/age/excel365/ladiesdf.pkl")
ladiesdf.to_excel("~/ski/elo/python/alpine/age/excel365/ladiesdf.xlsx")
