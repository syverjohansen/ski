...
def get_table(worldcup_page):
	...
	table = [date, city, country, distance]
	return table
...
workbook = xlsxwriter.Workbook("/Users/syverjohansen/ski/elo/python/alpine/excel365/update_scrape.xlsx")
