...
def ladies():
	lady_all_k = pd.read_excel('~/ski/elo/python/ski/age/excel365/varladies_all_k.xlsx', sheet_name="Sheet1", header=0)
	lady_distance_k = pd.read_excel('~/ski/elo/python/ski/age/excel365/varladies_distance_k.xlsx', sheet_name="Sheet1", header=0)
	lady_distance_k = lady_distance_k.rename(columns = {'pelo':'distance_pelo', 'elo':'distance_elo'})
	lady_distance_classic_k = pd.read_excel('~/ski/elo/python/ski/age/excel365/varladies_distance_classic_k.xlsx', sheet_name="Sheet1", header=0)
	lady_distance_classic_k = lady_distance_classic_k.rename(columns = {'pelo':'distance_classic_pelo', 'elo':'distance_classic_elo'})
	lady_distance_freestyle_k = pd.read_excel('~/ski/elo/python/ski/age/excel365/varladies_distance_freestyle_k.xlsx', sheet_name="Sheet1", header=0)
	...
	lady_sprint_k = pd.read_excel('~/ski/elo/python/ski/age/excel365/varladies_sprint_k.xlsx', sheet_name="Sheet1", header=0)
	lady_sprint_k = lady_sprint_k.rename(columns = {'pelo':'sprint_pelo', 'elo':'sprint_elo'})
	lady_sprint_classic_k = pd.read_excel('~/ski/elo/python/ski/age/excel365/varladies_sprint_classic_k.xlsx', sheet_name="Sheet1", header=0)
	lady_sprint_classic_k = lady_sprint_classic_k.rename(columns = {'pelo':'sprint_classic_pelo', 'elo':'sprint_classic_elo'})
	lady_sprint_freestyle_k = pd.read_excel('~/ski/elo/python/ski/age/excel365/varladies_sprint_freestyle_k.xlsx', sheet_name="Sheet1", header=0)
	lady_sprint_freestyle_k = lady_sprint_freestyle_k.rename(columns = {'pelo':'sprint_freestyle_pelo', 'elo':'sprint_freestyle_elo'})
	lady_classic_k = pd.read_excel('~/ski/elo/python/ski/age/excel365/varladies_classic_k.xlsx', sheet_name="Sheet1", header=0)
	lady_classic_k = lady_classic_k.rename(columns = {'pelo':'classic_pelo', 'elo':'classic_elo'})
	lady_freestyle_k = pd.read_excel('~/ski/elo/python/ski/age/excel365/varladies_freestyle_k.xlsx', sheet_name="Sheet1", header=0)
	...
	'pelo', 'elo' ]]
	lady_distance_k = lady_distance_k[['Unnamed: 0', 'date', 'city', 'country', 'level', 'sex', 'discipline', 'place', 'name', 'nation', 'id', 'season', 'race', 'age', 'exp',
	"distance_pelo", "distance_elo"]]
	lady_distance_classic_k = lady_distance_classic_k[['Unnamed: 0','date','city', 'country', 'level', 'sex', 'discipline', 'place', 'name', 'nation', 'id', 'season', 'race', 'age', 'exp',
	"distance_classic_pelo", "distance_classic_elo"]]
	lady_distance_freestyle_k = lady_distance_freestyle_k[['Unnamed: 0','date','city', 'country', 'level', 'sex', 'discipline', 'place', 'name', 'nation', 'id', 'season', 'race', 'age', 'exp',
	...
	lady_sprint_classic_k = lady_sprint_classic_k[['Unnamed: 0','date','city', 'country', 'level', 'sex', 'discipline', 'place', 'name', 'nation', 'id', 'season', 'race', 'age', 'exp',
	"sprint_classic_pelo", "sprint_classic_elo"]]
	lady_sprint_freestyle_k = lady_sprint_freestyle_k[['Unnamed: 0','date','city', 'country', 'level', 'sex', 'discipline', 'place', 'name', 'nation', 'id', 'season', 'race', 'age', 'exp',
	"sprint_freestyle_pelo", "sprint_freestyle_elo"]]
	lady_classic_k = lady_classic_k[['Unnamed: 0', 'date', 'city', 'country', 'level', 'sex', 'discipline', 'place', 'name', 'nation', 'id', 'season', 'race', 'age', 'exp',
	"classic_pelo", "classic_elo"]]
	lady_freestyle_k = lady_freestyle_k[['Unnamed: 0', 'date', 'city', 'country', 'level', 'sex', 'discipline', 'place', 'name', 'nation', 'id', 'season', 'race', 'age', 'exp',
	...
	lady_all_k6 = lady_all_k5.merge(lady_sprint_freestyle_k, on=["Unnamed: 0","date", 'city', 'country', 'level', 'sex', 'discipline', 'place', 'name', 'nation', 'id', 'season', 'race', 'age', 'exp'], how="left")
	lady_all_k7 = lady_all_k6.merge(lady_classic_k, on=["Unnamed: 0","date", 'city', 'country', 'level', 'sex', 'discipline', 'place', 'name', 'nation', 'id', 'season', 'race', 'age', 'exp'], how="left")
	lady_all_k8 = lady_all_k7.merge(lady_freestyle_k, on=["Unnamed: 0","date", 'city', 'country', 'level', 'sex', 'discipline', 'place', 'name', 'nation', 'id', 'season', 'race', 'age', 'exp'], how="left")
...
def men():
	man_all_k = pd.read_excel('~/ski/elo/python/ski/age/excel365/varmen_all_k.xlsx', sheet_name="Sheet1", header=0)
	man_distance_k = pd.read_excel('~/ski/elo/python/ski/age/excel365/varmen_distance_k.xlsx', sheet_name="Sheet1", header=0)
	man_distance_k = man_distance_k.rename(columns = {'pelo':'distance_pelo', 'elo':'distance_elo'})
	man_distance_classic_k = pd.read_excel('~/ski/elo/python/ski/age/excel365/varmen_distance_classic_k.xlsx', sheet_name="Sheet1", header=0)
	man_distance_classic_k = man_distance_classic_k.rename(columns = {'pelo':'distance_classic_pelo', 'elo':'distance_classic_elo'})
	man_distance_freestyle_k = pd.read_excel('~/ski/elo/python/ski/age/excel365/varmen_distance_freestyle_k.xlsx', sheet_name="Sheet1", header=0)
	man_distance_freestyle_k = man_distance_freestyle_k.rename(columns = {'pelo':'distance_freestyle_pelo', 'elo':'distance_freestyle_elo'})
	man_sprint_k = pd.read_excel('~/ski/elo/python/ski/age/excel365/varmen_sprint_k.xlsx', sheet_name="Sheet1", header=0)
	man_sprint_k = man_sprint_k.rename(columns = {'pelo':'sprint_pelo', 'elo':'sprint_elo'})
	man_sprint_classic_k = pd.read_excel('~/ski/elo/python/ski/age/excel365/varmen_sprint_classic_k.xlsx', sheet_name="Sheet1", header=0)
	man_sprint_classic_k = man_sprint_classic_k.rename(columns = {'pelo':'sprint_classic_pelo', 'elo':'sprint_classic_elo'})
	man_sprint_freestyle_k = pd.read_excel('~/ski/elo/python/ski/age/excel365/varmen_sprint_freestyle_k.xlsx', sheet_name="Sheet1", header=0)
	man_sprint_freestyle_k = man_sprint_freestyle_k.rename(columns = {'pelo':'sprint_freestyle_pelo', 'elo':'sprint_freestyle_elo'})
	man_classic_k = pd.read_excel('~/ski/elo/python/ski/age/excel365/varmen_classic_k.xlsx', sheet_name="Sheet1", header=0)
	man_classic_k = man_classic_k.rename(columns = {'pelo':'classic_pelo', 'elo':'classic_elo'})
	man_freestyle_k = pd.read_excel('~/ski/elo/python/ski/age/excel365/varmen_freestyle_k.xlsx', sheet_name="Sheet1", header=0)
	...
	'pelo', 'elo' ]]
	man_distance_k = man_distance_k[['Unnamed: 0', 'date', 'city', 'country', 'level', 'sex', 'discipline', 'place', 'name', 'nation', 'id', 'season', 'race', 'age', 'exp',
	"distance_pelo", "distance_elo"]]
	man_distance_classic_k = man_distance_classic_k[['Unnamed: 0','date','city', 'country', 'level', 'sex', 'discipline', 'place', 'name', 'nation', 'id', 'season', 'race', 'age', 'exp',
	"distance_classic_pelo", "distance_classic_elo"]]
	man_distance_freestyle_k = man_distance_freestyle_k[['Unnamed: 0','date','city', 'country', 'level', 'sex', 'discipline', 'place', 'name', 'nation', 'id', 'season', 'race', 'age', 'exp',
	"distance_freestyle_pelo", "distance_freestyle_elo"]]
	man_sprint_k = man_sprint_k[['Unnamed: 0', 'date', 'city', 'country', 'level', 'sex', 'discipline', 'place', 'name', 'nation', 'id', 'season', 'race', 'age','exp',
	"sprint_pelo", "sprint_elo"]]
	man_sprint_classic_k = man_sprint_classic_k[['Unnamed: 0','date','city', 'country', 'level', 'sex', 'discipline', 'place', 'name', 'nation', 'id', 'season', 'race', 'age','exp',
	"sprint_classic_pelo", "sprint_classic_elo"]]
	man_sprint_freestyle_k = man_sprint_freestyle_k[['Unnamed: 0','date','city', 'country', 'level', 'sex', 'discipline', 'place', 'name', 'nation', 'id', 'season', 'race', 'age','exp',
	"sprint_freestyle_pelo", "sprint_freestyle_elo"]]
	man_classic_k = man_classic_k[['Unnamed: 0', 'date', 'city', 'country', 'level', 'sex', 'discipline', 'place', 'name', 'nation', 'id', 'season', 'race', 'age','exp',
	"classic_pelo", "classic_elo"]]
...
ladiesdf.to_pickle("/Users/syverjohansen/ski/elo/python/ski/age/excel365/ladies_chrono.pkl")
ladiesdf.to_excel("/Users/syverjohansen/ski/elo/python/ski/age/excel365/ladies_chrono.xlsx")

mendf.to_pickle("/Users/syverjohansen/ski/elo/python/ski/age/excel365/men_chrono.pkl")
mendf.to_excel("/Users/syverjohansen/ski/elo/python/ski/age/excel365/men_chrono.xlsx")
