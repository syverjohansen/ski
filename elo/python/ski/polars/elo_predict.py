...
def sex(df, sex):
    if(sex=="M"):
        df = pl.read_csv("~/ski/elo/python/ski/polars/excel365/all_men_scrape_update.csv")
    else:
        df = pl.read_csv("~/ski/elo/python/ski/polars/excel365/all_ladies_scrape_update.csv")
