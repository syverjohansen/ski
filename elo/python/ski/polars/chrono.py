...
def ladies():
    ...
    L_Distance = pl.read_csv(f'{base_path}/L_Distance.csv')
    L_Distance = L_Distance.rename({"Pelo": "Distance_Pelo", "Elo": "Distance_Elo"})
    L_Distance_C = pl.read_csv(f'{base_path}/L_Distance_C.csv')
    L_Distance_C = L_Distance_C.rename({'Pelo': 'Distance_C_Pelo', 'Elo': 'Distance_C_Elo'})
    L_Distance_F = pl.read_csv(f'{base_path}/L_Distance_F.csv')
...
def men():
    ...
    M_Distance = pl.read_csv(f'{base_path}/M_Distance.csv')
    M_Distance = M_Distance.rename({"Pelo": "Distance_Pelo", "Elo": "Distance_Elo"})
    M_Distance_C = pl.read_csv(f'{base_path}/M_Distance_C.csv')
    M_Distance_C = M_Distance_C.rename({'Pelo': 'Distance_C_Pelo', 'Elo': 'Distance_C_Elo'})
    M_Distance_F = pl.read_csv(f'{base_path}/M_Distance_F.csv')
