...
ADDITIONAL_SKIERS_MEN = {
    ...
    'Norway': [
        ...
        {'name': 'Erik Valnes', 'yes': [1, 2]},
        {'name': 'Amund Korsæth', 'yes': [1], 'no': [2]},
        {'name': 'Oscar Opstad Vike', 'yes': [1], 'no': [2]},
        {'name': 'Ansgar Evensen', 'yes': [1], 'no': [2]},
        {'name': 'Mats Opsal', 'yes': [1], 'no': [2]},
        {'name': 'Edvard Sandvik', 'yes': [2], 'no': [1]},
        {'name': 'Johannes Høsflot Klæbo', 'yes': [1, 2]},
        {'name': 'Håvard Moseby', 'yes': [1, 2]},
        {'name': 'Emil Iversen', 'yes': [2], 'no': [1]},
        {'name': 'Harald Østberg Amundsen', 'yes': [2], 'no': [1]},
...
ADDITIONAL_SKIERS_LADIES = {
    ...
    'Norway': [
        {'name': 'Helene Ekreim Haugen', 'yes': [1], 'no': [2]},
        ...
        {'name': 'Maren Wangensteen', 'yes': [2], 'no': [1]},
        {'name': 'Karoline Simpson-Larsen', 'yes': [2], 'no': [1]},
        {'name': 'Anne Kjersti Kalvå', 'yes': [2], 'no': [1]},
