...
def create_team_sprint_championships_startlist(gender: str, races_df: pd.DataFrame) -> None:
    ...
    # Use individual ELO data for team sprint selection
    elo_path = f"~/ski/elo/python/ski/polars/excel365/{gender}_chrono.csv"
...
def create_mixed_relay_championships_startlist(races_df: pd.DataFrame) -> None:
    ...
    try:
        ...
        men_elo = get_latest_elo_scores("~/ski/elo/python/ski/polars/excel365/men_chrono.csv")
        ladies_elo = get_latest_elo_scores("~/ski/elo/python/ski/polars/excel365/ladies_chrono.csv")
