...
ladiesdf = pd.read_pickle("~/ski/elo/python/ski/age/excel365/ladiesdf.pkl")
...
ladiesdf['name']= ladiesdf['name'].str.replace('Ã¤', 'ä')
ladiesdf['name']= ladiesdf['name'].str.replace('Ã¼', 'ü')
ladiesdf['name'] = ladiesdf['name'].str.replace('Ã¶', 'ö')
ladiesdf['name'] = ladiesdf['name'].str.replace('Ã', 'Ø')
ladiesdf['name'] = ladiesdf['name'].str.replace('Ã¦', 'æ')
ladiesdf['name']= ladiesdf['name'].str.replace('Ã¥', 'å')
ladiesdf['name']= ladiesdf['name'].str.replace('Ã', 'Å')
...
varladieselo.to_pickle("~/ski/elo/python/ski/age/excel365/varladies_freestyle_k.pkl")
varladieselo.to_excel("~/ski/elo/python/ski/age/excel365/varladies_freestyle_k.xlsx")
