...
mendf = pd.read_pickle("~/ski/elo/python/biathlon/age/excel365/mendf.pkl")
#print(mendf)
update_mendf = pd.read_pickle("~/ski/elo/python/biathlon/age/excel365/menupdate_setup.pkl")
...
#varmendf = discipline(varmendf, "Mass Start")
#varmendf = season(varmendf, 0, 9999)
varmenelo = male_elo(varmendf)
varmenelo.to_pickle("~/ski/elo/python/biathlon/age/excel365/varmen_all_k.pkl")
varmenelo.to_excel("~/ski/elo/python/biathlon/age/excel365/varmen_all_k.xlsx")
