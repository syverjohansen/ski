...
xlsx = pd.ExcelFile('~/ski/elo/python/biathlon/excel365/all.xlsx')
...
ladiesdf.to_pickle("~/ski/elo/python/biathlon/excel365/ladiesdf.pkl")
ladiesdf.to_excel("~/ski/elo/python/biathlon/excel365/ladiesdf.xlsx")



mendf = men_setup()
mendf.to_pickle("~/ski/elo/python/biathlon/excel365/mendf.pkl")
mendf.to_excel("~/ski/elo/python/biathlon/excel365/mendf.xlsx")
