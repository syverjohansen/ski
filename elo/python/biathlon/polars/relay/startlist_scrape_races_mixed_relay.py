...
def process_races_mixed_relay(races_file: str = None) -> None:
    """
    Process mixed relay races from races.csv, creating team CSV files
...
def process_mixed_relay_races(races_df: pd.DataFrame) -> None:
    ...
    team_output_path = "~/ski/elo/python/biathlon/polars/relay/excel365/startlist_mixed_relay_races_teams.csv"
...
def process_mixed_relay_teams(teams: List[Dict], race: pd.Series, men_elo_scores: pd.DataFrame, women_elo_scores: pd.DataFrame) -> List[Dict]:
    ...
    for team in teams:
        ...
        # Add race probability column - 100% for this race
        team_info['Race1_Prob'] = 1.0
...
if __name__ == "__main__":
    ...
    process_races_mixed_relay(races_file)
