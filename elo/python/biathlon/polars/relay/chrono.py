...
ladiesdf.write_ipc("~/ski/elo/python/biathlon/polars/relay/excel365/ladies_chrono.feather")
mendf.write_ipc("~/ski/elo/python/biathlon/polars/relay/excel365/men_chrono.feather")
