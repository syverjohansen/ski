...
def fetch_season_links(year, sex='M'):
    ...
    base_url = f"https://firstskisport.com/biathlon/calendar.php?y={year}"
    if sex == 'L':
        base_url += "&g=w"
...
def save_dataframes(men_df, ladies_df, base_path="~/ski/elo/python/biathlon/polars/relay/excel365"):
