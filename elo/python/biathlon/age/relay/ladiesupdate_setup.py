...
def setup():
	...
	#print(refdf)
	xlsx = pd.ExcelFile("~/ski/elo/python/ski/age/relay/excel365/update_scrape.xlsx")
...
df = setup()
print(df)
df.to_pickle("~/ski/elo/python/ski/age/relay/excel365/ladiesupdate_setup.pkl")
df.to_pickle("~/ski/elo/python/ski/age/relay/excel365/ladiesupdate_setup.xlsx")
