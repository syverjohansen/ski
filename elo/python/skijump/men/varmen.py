...
def hill(mendf, hill):
   # print(pd.unique(mendf['distance']))
    if(hill=="Normal"):
        mendf = mendf.loc[mendf['hill']=="Normal"]
    elif(hill=="Large"):
        mendf = mendf.loc[mendf['hill']!="Normal"]
...
varmenelo.to_pickle("~/ski/elo/python/skijump/excel365/varmen_all_k.pkl")
varmenelo.to_excel("~/ski/elo/python/skijump/excel365/varmen_all_k.xlsx")
