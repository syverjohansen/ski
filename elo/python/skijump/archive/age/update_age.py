...
men_pkl = pd.read_pickle("~/ski/elo/python/skijump/age/excel365/mendf.pkl")
update_mendf = pd.read_pickle("~/ski/elo/python/skijump/age/excel365/menupdate_setup.pkl")

men_pkl = men_pkl.append(update_mendf, ignore_index=True)



ladies_pkl = pd.read_pickle("~/ski/elo/python/skijump/age/excel365/ladiesdf.pkl")

update_ladiesdf =  pd.read_pickle("~/ski/elo/python/skijump/age/excel365/ladiesupdate_setup.pkl")
...
def men_ages(mendf):
	...
	id_urls = list(map(lambda x: "https://firstskisport.com/ski-jumping/athlete.php?id="+str(x), id_list))
...
def ladies_ages(ladiesdf):
	...
	big_id_list = list(big_df['id'].unique())
	id_urls = list(map(lambda x: "https://firstskisport.com/ski-jumping/athlete.php?id="+str(x)+"&g=F", id_list))
...
mendf.to_pickle("~/ski/elo/python/skijump/age/excel365/menupdate_setup.pkl")
mendf.to_excel("~/ski/elo/python/skijump/age/excel365/menupdate_setup.xlsx")


ladiesdf = ladies_ages(ladies_pkl)
ladiesdf.to_pickle("~/ski/elo/python/skijump/age/excel365/ladiesupdate_setup.pkl")
ladiesdf.to_excel("~/ski/elo/python/skijump/age/excel365/ladiesupdate_setup.xlsx")
