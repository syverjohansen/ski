...
def process_weekend_mixed_team_races(races_file: str = None) -> None:
    ...
    """
    print("Processing Ski Jumping weekend mixed team races")
    ...
    if races_file and os.path.exists(races_file):
        ...
        try:
            ...
            # Filter to only mixed team races
...
def process_mixed_team_races(races_df: pd.DataFrame) -> None:
    ...
    team_output_path = "~/ski/elo/python/skijump/polars/relay/excel365/startlist_mixed_team_weekend_teams.csv"
    
    # Create output directory if it doesn't exist
    os.makedirs(os.path.dirname(os.path.expanduser(team_output_path)), exist_ok=True)
    
    # Get the ELO scores for both genders
    men_elo_path = "~/ski/elo/python/skijump/polars/relay/excel365/men_chrono.csv"
    women_elo_path = "~/ski/elo/python/skijump/polars/relay/excel365/ladies_chrono.csv"
