...
ladiesdf.write_csv("~/ski/elo/python/skijump/polars/relay/excel365/ladies_chrono_dyn.csv")
mendf.write_csv("~/ski/elo/python/skijump/polars/relay/excel365/men_chrono_dyn.csv")
