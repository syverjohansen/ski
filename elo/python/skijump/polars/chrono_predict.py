...
ladiesdf.write_csv("~/ski/elo/python/skijump/polars/excel365/ladies_chrono_pred.csv")
mendf.write_csv("~/ski/elo/python/skijump/polars/excel365/men_chrono_pred.csv")
