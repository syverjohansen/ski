...
def create_weekends_from_races(input_file="excel365/races.csv", output_file="excel365/weekends.csv"):
    ...
    try:
        ...
        print(f"Reading Ski Jumping races data from {input_file}...")
...
if __name__ == "__main__":
    print("Creating Ski Jumping weekends.csv from races.csv...")
    ...
    if not os.path.exists(input_file):
        ...
        if result is not None:
            print("Ski Jumping weekend creation complete!")
        else:
