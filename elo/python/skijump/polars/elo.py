...
def sex(df, sex):
    ...
    if(sex=="M"):
        df = pl.read_ipc("~/ski/elo/python/skijump/polars/excel365/men_scrape_update.feather")
    else:
        df = pl.read_ipc("~/ski/elo/python/skijump/polars/excel365/ladies_scrape_update.feather")
