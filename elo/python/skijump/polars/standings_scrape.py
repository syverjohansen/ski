#!/usr/bin/env python3
"""
Ski jumping standings scraper for FirstSkiSport.
...
# Updated URLs for Ski Jumping World Cup rankings
MEN_URL = "https://firstskisport.com/ski-jumping/ranking.php?y=2026&cup=1"
WOMEN_URL = "https://firstskisport.com/ski-jumping/ranking.php?y=2026&g=w&cup=1"
...
def scrape_standings(url, gender):
    ...
    """
    start_time = time()
    logger.info(f"Starting to scrape {gender}'s Ski Jumping World Cup standings from {url}")
...
def main():
    ...
    logger.info("Scraping men's Ski Jumping World Cup standings...")
    men_data = scrape_standings(MEN_URL, 'men')
    save_to_csv(men_data, MEN_OUTPUT)
    
    # Scrape women's standings
    logger.info("Scraping women's Ski Jumping World Cup standings...")
