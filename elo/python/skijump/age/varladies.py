...
ladiesdf = pd.read_pickle("~/ski/elo/python/skijump/age/excel365/ladiesdf.pkl")
...
def k_finder(ladiesdf, varladiesdf, season, max_var_length):
    ...
    k = max(1,min(5,float(max_var_length/3), float(max_var_length/varraces)))
    
    #k = max(1,min(float(max_var_length/2), float(max_var_length/varraces)))
    return k
   ...
   # print(id_dict)
    ...
    #for season in range(10):
        ...
        for idd in ski_ids_s:
            ...
            endf = pd.DataFrame([[endseasondate, "Summer", "Break", "end", "L", None,  0
...
#varladiesdf = distance(varladiesdf, "Tech")
...
varladieselo.to_pickle("~/ski/elo/python/skijump/age/excel365/varladies_all_k.pkl")
varladieselo.to_excel("~/ski/elo/python/skijump/age/excel365/varladies_all_k.xlsx")
