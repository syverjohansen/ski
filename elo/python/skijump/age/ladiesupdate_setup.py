...
df = setup()
df.to_pickle("~/ski/elo/python/skijump/age/excel365/ladiesupdate_setup.pkl")
df.to_excel("~/ski/elo/python/skijump/age/excel365/ladiesupdate_setup.xlsx")
#df = elo(refdf, df)
#print(df)
#print(refdf["id"])
#print(df['id'])
#df.to_pickle("~/ski/elo/python/biathlon/ladies/ladiesupdate.pkl")
#df.to_excel("~/ski/elo/python/biathlon/ladies/ladiesupdate.xlsx")
