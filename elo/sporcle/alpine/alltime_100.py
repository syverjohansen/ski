...
dfs = ['/Users/syverjohansen/ski/ranks/alpine/excel365/varmen_points.pkl',
'/Users/syverjohansen/ski/ranks/alpine/excel365/varladies_points.pkl']
for a in range(len(dfs)):
	...
	filepath = '/Users/syverjohansen/ski/elo/sporcle/alpine/excel365/alltime_100_'+filepath+'_sporcle.xlsx'
