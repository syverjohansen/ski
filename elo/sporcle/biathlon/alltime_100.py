...
def get_active(df, sex):
	...
	if(sex=="men"):
		all_skiers = pd.read_pickle('/Users/syverjohansen/ski/elo/python/biathlon/excel365/varmen_all_k.pkl')
	else:
		all_skiers = pd.read_pickle('/Users/syverjohansen/ski/elo/python/biathlon/excel365/varladies_all_k.pkl')
...
dfs = ['/Users/syverjohansen/ski/ranks/biathlon/excel365/varmen_points.pkl',
'/Users/syverjohansen/ski/ranks/biathlon/excel365/varladies_points.pkl']
for a in range(len(dfs)):
	...
	filepath = '/Users/syverjohansen/ski/elo/sporcle/biathlon/excel365/alltime_100_'+filepath+'_sporcle.xlsx'
