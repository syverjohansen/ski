...
xlsx = pd.ExcelFile('~/ski/ranks/alpine/excel365/all.xlsx')
update = pd.ExcelFile('~/ski/ranks/alpine/excel365/update_scrape.xlsx')
...
def ladies_setup():
	...
	ladiesdf.columns = ['date', 'city', 'country', 'category', 'sex', 'distance',  'place', 'name', 'nation', 'id']
	lady_seasons = []
...
def men_setup():
	...
	mendf.columns = ['date', 'city', 'country', 'category', 'sex', 'distance',  'place', 'name', 'nation', 'id']
...
ladiesdf.to_pickle("~/ski/ranks/alpine/excel365/ladiesdf.pkl")
ladiesdf.to_excel("~/ski/ranks/alpine/excel365/ladiesdf.xlsx")



mendf = men_setup()
mendf.to_pickle("~/ski/ranks/alpine/excel365/mendf.pkl")
mendf.to_excel("~/ski/ranks/alpine/excel365/mendf.xlsx")
